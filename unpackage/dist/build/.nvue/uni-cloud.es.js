...
const S = false, b = "app", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b;
I("");
const T = I("[]") || [];
let O = "";
try {
...
function Bn(e2) {
  ...
  e2.callFunction = function(t3) {
    ...
    let o2, a2;
    if (t3.data = t3.data || {}, o2 = n2, o2 = o2.bind(e2), Kn(t3))
      a2 = n2.call(e2, t3);
    else if (Fn(t3)) {
...
let Js = new class {
  init(e2) {
    ...
    t2 = n2.init(e2), Hs(t2), Bn(t2), function(e3) {
