...
<script>
	import componentPage from '@/pages/tabBar/main/Main.vue'
	import API from '@/pages/tabBar/tendency/Tendency.vue'
	import extUI from '@/pages/tabBar/share/Share.vue'
	import templatePage from '@/pages/tabBar/my/My.vue'
	import {
		mapMutations,
		mapState
	} from 'vuex'
